...
import type { DemoEmail, DemoEvent, DemoFlags, DemoState } from "@/lib/types";

const storePath = path.join(process.cwd(), ".data", "skrutai-webinar-guardian.json");

const initialState = (): DemoState => ({
  config: {
    projectName: "skrutai-webinar-guardian",
    repoName: "repo-x",
    branchName: "main",
    recipientEmail: "demo@skrutai.ai",
    deployUrl: "https://skrutai-webinar-guardian.vercel.app",
    thresholds: {
      hallucination: 0.8,
      ragPrecision: 0.75,
      ragRecall: 0.75,
  ...
  events: [
    {
      ...
      detail: "Demo state is ready for push, deployment, and tracing simulations.",
